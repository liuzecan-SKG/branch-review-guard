...
| Claude Code（插件，推荐） | `/plugin marketplace add liuzecan-SKG/branch-review-guard` → `/plugin install branch-review-guard@branch-review-guard` | 经 `.claude-plugin/` 一键装全套（3 skill + 5 子代理 + `/branch-review-guard` 命令），支持启停/版本/复用 |
